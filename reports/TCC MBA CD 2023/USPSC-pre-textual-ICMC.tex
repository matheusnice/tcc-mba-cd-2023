...
\titulo{Inteligência Artificial Explicável na Previsão de Reinternação Hospitalar: Uma Análise de Modelos de Aprendizado de Máquina}
\titleabstract{Explainable Artificial Intelligence in Hospital Readmission Prediction: An Analysis of Machine Learning Models}
\tituloadic{Explainable Artificial Intelligence in Hospital Readmission Prediction: An Analysis of Machine Learning Models}
\tituloresumo{Inteligência Artificial Explicável na Previsão de Reinternação Hospitalar: Uma Análise de Modelos de Aprendizado de Máquina}
